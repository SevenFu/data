...
class StreamingVP9IntelMeasurement(legacy_page_test.LegacyPageTest):
  def ValidateAndMeasurePage(self, page, tab, results):
    ...
    pa.start('streamingVP94KIntel.ex')
    vms.start('streamingVP94KIntel.vms')
...
class StreamingVP94KIntel(benchmark.Benchmark):
  ...
  def CreateStorySet(self, options):
    ...
    ps.AddStory(page_mod.Page(_URL, ps, ps.base_dir, name="VP9-4K-30FPS"))
    return ps
